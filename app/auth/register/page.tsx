...
import { Database, Eye, EyeOff, Loader2, Mail, Lock, User, ArrowRight, CheckCircle } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md animate-in fade-in slide-in-from-bottom-8 duration-1000">
                ...
                <div className="text-center mb-8 animate-in fade-in slide-in-from-top-4 duration-1000 delay-300">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">Join DataDash</h1>
                    ...
                    <CardContent className="space-y-6">
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="space-y-2 animate-in fade-in slide-in-from-right-4 duration-700 delay-700">
                                    ...
                                    <Input
                                        ...
                                        className="h-12 border-gray-200 focus:border-amber-500 focus:ring-amber-500 transition-all duration-200"
                                    />
                                </div>
                            </div>

                            {/* Email Field */}
                            <div className="space-y-2 animate-in fade-in slide-in-from-left-4 duration-700 delay-900">
                            ...
                            {/* Password Field */}
                            <div className="space-y-2 animate-in fade-in slide-in-from-right-4 duration-700 delay-1100">
                            ...
                            <div className="space-y-2 animate-in fade-in slide-in-from-left-4 duration-700 delay-1300">
                            ...
                            {/* Terms Checkbox */}
                            <div className="flex items-start space-x-2 animate-in fade-in duration-700 delay-1500">
                                <Checkbox
                                    id="terms"
                                    checked={acceptTerms}
                            ...
                            <Button
                                type="submit"
                                disabled={loading}
                                className="w-full h-12 bg-amber-500 hover:bg-amber-600 text-white font-medium transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] animate-in fade-in slide-in-from-bottom-4 duration-700 delay-1700"
                            >
                                {loading ? (
                                    <>
                        ...
                        {/* Divider */}
                        <div className="relative animate-in fade-in duration-700 delay-1900">
                            <Separator />
                        ...
                        {/* Social Registration */}
                        <div className="space-y-3 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-2100">
                            <Button
                                variant="outline"
                        ...
                        {/* Sign In Link */}
                        <div className="text-center animate-in fade-in duration-700 delay-2300">
